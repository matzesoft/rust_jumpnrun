...
pub fn spawn_trap_collision(
    ...
    trap_query: Query<(&GridCoords, &Parent), Added<crate::asset_system::traps::Trap>>,
    parent_query: Query<&Parent, Without<crate::asset_system::traps::Trap>>,
...
pub fn spawn_trap_sensor(
    mut commands: Commands,
    detect_trap_for: Query<(Entity, &Collider), Added<crate::asset_system::traps::TrapDetection>>,
) {
        ...
        if let Some(cuboid) = shape.as_cuboid() {
            ...
            commands.entity(entity).with_children(|builder| {
                builder
                    ...
                    .insert(GlobalTransform::default())
                    .insert(crate::asset_system::traps::TrapSensor {
...
pub fn trap_detection(
    mut trap_sensors: Query<&mut crate::asset_system::traps::TrapSensor>,
...
pub fn update_on_trap(
    mut trap_detectors: Query<&mut crate::asset_system::traps::TrapDetection>,
    trap_sensors: Query<&crate::asset_system::traps::TrapSensor, Changed<crate::asset_system::traps::TrapSensor>>,
